...
local Themes = {
        ...
        XRayNe = {
                ...
                AcrylicBorder = Color3.fromRGB(25, 25, 30),
                AcrylicGradient = ColorSequence.new(Color3.fromRGB(5, 5, 10), Color3.fromRGB(15, 15, 20)),
                AcrylicNoise = 0.96,
                ...
                DialogBorder = Color3.fromRGB(35, 35, 40),
                DialogInput = Color3.fromRGB(30, 30, 35),
                DialogInputLine = Color3.fromRGB(100, 100, 105),
...
local function toMotor(value)
        ...
        error(("无法将%q转换为电机；不支持类型%s"):format(value, valueType), 2)
end
...
local SaveManager = {} do
        ...
        function SaveManager:Load(name)
                ...
                if not isfile(file) then return false, "创建配置保存文件" end
        ...
        function SaveManager:BuildConfigSection(tab)
                ...
                section:AddButton({Title = "保存配置", Callback = function()
                        local name = SaveManager.Options.SaveManager_ConfigList.Value
